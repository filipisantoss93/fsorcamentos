/* FS ORÇAMENTOS — camada visual do polimento do gerador */
function aplicarPolimentoGerador() {
  ...
  window.limparFormulario = function limparFormularioPolido(forcar = false) {
    ...
    if (!forcar && temConteudo && !confirm('Iniciar um novo orçamento? Os dados ainda não salvos serão apagados.')) return false;
